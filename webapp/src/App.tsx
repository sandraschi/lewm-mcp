...
const API_BASE = "http://127.0.0.1:10927";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Real subprocess bridge to <strong>lucas-maes/le-wm</strong> —{" "}
          <code>train.py</code> and <code>eval.py</code> in upstream Python 3.10
          venv.
        </p>
        <p
          style={{
        ...
        >
          ...
          (LeWorldModel) · full text in <strong>arxiv-mcp</strong> depot after{" "}
          <code>tools/ingest_lewm_paper.ps1</code>
        </p>
          ...
          >
            ...
            <dd style={{ margin: 0 }}>
              {status.upstream_configured
                ? status.upstream_path
                : "not found — run bootstrap_upstream.ps1"}
            </dd>
            <dt style={{ color: "#94a3b8" }}>Upstream venv</dt>
            <dd style={{ margin: 0 }}>
              {status.upstream_python_ready ? "ready" : "missing"}
            </dd>
            <dt style={{ color: "#94a3b8" }}>STABLEWM_HOME</dt>
            <dd
              style={{ margin: 0, fontFamily: "monospace", fontSize: "0.8rem" }}
            >
              {status.stablewm_home}
            </dd>
            <dt style={{ color: "#94a3b8" }}>Policy</dt>
            <dd style={{ margin: 0 }}>
              {status.default_policy_ready ? "checkpoint ok" : "not ready"}
            </dd>
        ...
        {jobs.length > 0 && (
          <div style={{ marginTop: "1.25rem" }}>
            <h2 style={{ fontSize: "0.95rem", color: "#cbd5e1" }}>
              Recent jobs
            </h2>
            <ul
              style={{
        ...
        <footer
          style={{ marginTop: "1.5rem", fontSize: "0.8rem", color: "#64748b" }}
        >
          API <strong>10927</strong> · Vite <strong>10928</strong> · MCP{" "}
          <code>/mcp</code>
        </footer>
      </div>
    </div>
